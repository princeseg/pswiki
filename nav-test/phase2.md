...
published: true
date: 2026-03-23T11:19:36.594Z
tags: logsmith
editor: markdown
dateCreated: 2026-03-23T11:19:36.594Z
---

# Phase 2 - Service Deployment
## Overview
This document outlines the process of deploying Docker containers in an on-prem environment, which was completed on March 23, 2026.

## Environment
The deployment took place in an on-prem environment, utilizing the following key details:
- Operating System: [Insert OS details]
- Docker Version: [Insert Docker version]
- Containerization Method: [Insert containerization method]

## Step-by-Step Build Guide

1. Deployed Docker containers
    ```bash
docker-compose up -d
```
...
## Summary
The deployment of Docker containers was completed successfully, and the service is now operational.
...
<li class="config-item">
  <div class="navigation">
    <div class="nav-back">
      <a href="/nav-test/phase1" class="back">Previous <span class="label">Infrastructure Setup</span></a>
    </div>
